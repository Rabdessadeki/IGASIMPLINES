...
#define MOD_I1VMYDM21TUN_WRAPPER

#include "mod_i1vmydm21tun_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_i1vmydm21tun_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_i1vmydm21tun_module = {
    ...
    0,
    mod_i1vmydm21tun_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_i1vmydm21tun(void)
{
    PyObject* mod;
    static void* Pymod_i1vmydm21tun_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_i1vmydm21tun_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_i1vmydm21tun_API, "mod_i1vmydm21tun._C_API", NULL);
