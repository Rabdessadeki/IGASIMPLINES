...
#define MOD_7PBJPMWNMB1R_WRAPPER

#include "mod_7pbjpmwnmb1r_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_7pbjpmwnmb1r_methods[] = {
    {
...
static struct PyModuleDef mod_7pbjpmwnmb1r_module = {
    ...
    0,
    mod_7pbjpmwnmb1r_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_7pbjpmwnmb1r(void)
{
    PyObject* mod;
    static void* Pymod_7pbjpmwnmb1r_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_7pbjpmwnmb1r_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_7pbjpmwnmb1r_API, "mod_7pbjpmwnmb1r._C_API", NULL);
