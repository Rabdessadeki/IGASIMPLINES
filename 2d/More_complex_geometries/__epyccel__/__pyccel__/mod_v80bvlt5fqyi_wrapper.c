...
#define MOD_V80BVLT5FQYI_WRAPPER

#include "mod_v80bvlt5fqyi_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
/*........................................*/
static PyObject* bind_c_assemble_matrix_ex01_wrapper(PyObject* self, PyObject* args, PyObject* kwargs)
{
    PyObject* ne1_obj;
    PyObject* ne2_obj;
    PyObject* p1_obj;
...
static PyMethodDef mod_v80bvlt5fqyi_methods[] = {
    {
        "assemble_matrix_ex01",
        (PyCFunction)bind_c_assemble_matrix_ex01_wrapper,
...
static struct PyModuleDef mod_v80bvlt5fqyi_module = {
    ...
    0,
    mod_v80bvlt5fqyi_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_v80bvlt5fqyi(void)
{
    PyObject* mod;
    static void* Pymod_v80bvlt5fqyi_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_v80bvlt5fqyi_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_v80bvlt5fqyi_API, "mod_v80bvlt5fqyi._C_API", NULL);
