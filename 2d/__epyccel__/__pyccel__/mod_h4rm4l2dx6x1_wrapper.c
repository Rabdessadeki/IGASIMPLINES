...
#define MOD_H4RM4L2DX6X1_WRAPPER

#include "mod_h4rm4l2dx6x1_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_h4rm4l2dx6x1_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_h4rm4l2dx6x1_module = {
    ...
    0,
    mod_h4rm4l2dx6x1_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_h4rm4l2dx6x1(void)
{
    PyObject* mod;
    static void* Pymod_h4rm4l2dx6x1_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_h4rm4l2dx6x1_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_h4rm4l2dx6x1_API, "mod_h4rm4l2dx6x1._C_API", NULL);
