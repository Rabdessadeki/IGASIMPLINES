...
#define MOD_HNZASTVERS9G_WRAPPER

#include "mod_hnzastvers9g_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_hnzastvers9g_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_hnzastvers9g_module = {
    ...
    0,
    mod_hnzastvers9g_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_hnzastvers9g(void)
{
    PyObject* mod;
    static void* Pymod_hnzastvers9g_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_hnzastvers9g_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_hnzastvers9g_API, "mod_hnzastvers9g._C_API", NULL);
