...
#define MOD_FEB12L6QNH3W_WRAPPER

#include "mod_feb12l6qnh3w_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_feb12l6qnh3w_methods[] = {
    {
...
static struct PyModuleDef mod_feb12l6qnh3w_module = {
    ...
    0,
    mod_feb12l6qnh3w_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_feb12l6qnh3w(void)
{
    PyObject* mod;
    static void* Pymod_feb12l6qnh3w_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_feb12l6qnh3w_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_feb12l6qnh3w_API, "mod_feb12l6qnh3w._C_API", NULL);
