...
#define MOD_K9AIKF59ZUKF_WRAPPER

#include "mod_k9aikf59zukf_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
/*........................................*/
static PyObject* bind_c_assemble_vector_ex001_wrapper(PyObject* self, PyObject* args, PyObject* kwargs)
{
    PyObject* ne1_obj;
    PyObject* ne2_obj;
    PyObject* p1_obj;
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "OOOOOOOOOOOOO", kwlist, &ne1_obj, &ne2_obj, &p1_obj, &p2_obj, &spans_1_obj, &spans_2_obj, &basis_1_obj, &basis_2_obj, &weights_1_obj, &weights_2_obj, &points_1_obj, &points_2_obj, &rhs_obj))
    {
        return NULL;
    }
...
static PyMethodDef mod_k9aikf59zukf_methods[] = {
    {
        "assemble_vector_ex001",
        (PyCFunction)bind_c_assemble_vector_ex001_wrapper,
...
static struct PyModuleDef mod_k9aikf59zukf_module = {
    ...
    0,
    mod_k9aikf59zukf_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_k9aikf59zukf(void)
{
    PyObject* mod;
    static void* Pymod_k9aikf59zukf_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_k9aikf59zukf_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_k9aikf59zukf_API, "mod_k9aikf59zukf._C_API", NULL);
