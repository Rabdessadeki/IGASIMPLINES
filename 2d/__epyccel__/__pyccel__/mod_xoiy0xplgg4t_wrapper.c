...
#define MOD_XOIY0XPLGG4T_WRAPPER

#include "mod_xoiy0xplgg4t_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_xoiy0xplgg4t_methods[] = {
    {
...
static struct PyModuleDef mod_xoiy0xplgg4t_module = {
    ...
    0,
    mod_xoiy0xplgg4t_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_xoiy0xplgg4t(void)
{
    PyObject* mod;
    static void* Pymod_xoiy0xplgg4t_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_xoiy0xplgg4t_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_xoiy0xplgg4t_API, "mod_xoiy0xplgg4t._C_API", NULL);
