...
#define MOD_DZOQ9IW5KA43_WRAPPER

#include "mod_dzoq9iw5ka43_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_dzoq9iw5ka43_methods[] = {
    {
...
static struct PyModuleDef mod_dzoq9iw5ka43_module = {
    ...
    0,
    mod_dzoq9iw5ka43_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_dzoq9iw5ka43(void)
{
    PyObject* mod;
    static void* Pymod_dzoq9iw5ka43_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_dzoq9iw5ka43_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_dzoq9iw5ka43_API, "mod_dzoq9iw5ka43._C_API", NULL);
