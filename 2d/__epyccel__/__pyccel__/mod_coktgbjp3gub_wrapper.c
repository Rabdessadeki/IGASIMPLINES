...
#define MOD_COKTGBJP3GUB_WRAPPER

#include "mod_coktgbjp3gub_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_coktgbjp3gub_methods[] = {
    {
...
static struct PyModuleDef mod_coktgbjp3gub_module = {
    ...
    0,
    mod_coktgbjp3gub_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_coktgbjp3gub(void)
{
    PyObject* mod;
    static void* Pymod_coktgbjp3gub_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_coktgbjp3gub_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_coktgbjp3gub_API, "mod_coktgbjp3gub._C_API", NULL);
