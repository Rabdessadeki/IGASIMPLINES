...
#define MOD_6O9JBNK6ATZW_WRAPPER

#include "mod_6o9jbnk6atzw_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_6o9jbnk6atzw_methods[] = {
    {
...
static struct PyModuleDef mod_6o9jbnk6atzw_module = {
    ...
    0,
    mod_6o9jbnk6atzw_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_6o9jbnk6atzw(void)
{
    PyObject* mod;
    static void* Pymod_6o9jbnk6atzw_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_6o9jbnk6atzw_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_6o9jbnk6atzw_API, "mod_6o9jbnk6atzw._C_API", NULL);
