...
#define MOD_9WDP269BS4VV_WRAPPER

#include "mod_9wdp269bs4vv_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_9wdp269bs4vv_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_9wdp269bs4vv_module = {
    ...
    0,
    mod_9wdp269bs4vv_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_9wdp269bs4vv(void)
{
    PyObject* mod;
    static void* Pymod_9wdp269bs4vv_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_9wdp269bs4vv_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_9wdp269bs4vv_API, "mod_9wdp269bs4vv._C_API", NULL);
