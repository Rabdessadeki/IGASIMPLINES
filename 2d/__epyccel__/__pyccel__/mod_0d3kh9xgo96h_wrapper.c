...
#define MOD_0D3KH9XGO96H_WRAPPER

#include "mod_0d3kh9xgo96h_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0d3kh9xgo96h_methods[] = {
    {
...
static struct PyModuleDef mod_0d3kh9xgo96h_module = {
    ...
    0,
    mod_0d3kh9xgo96h_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0d3kh9xgo96h(void)
{
    PyObject* mod;
    static void* Pymod_0d3kh9xgo96h_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0d3kh9xgo96h_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0d3kh9xgo96h_API, "mod_0d3kh9xgo96h._C_API", NULL);
