...
#define MOD_1C190DBFYSY9_WRAPPER

#include "mod_1c190dbfysy9_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_1c190dbfysy9_methods[] = {
    {
...
static struct PyModuleDef mod_1c190dbfysy9_module = {
    ...
    0,
    mod_1c190dbfysy9_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_1c190dbfysy9(void)
{
    PyObject* mod;
    static void* Pymod_1c190dbfysy9_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_1c190dbfysy9_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_1c190dbfysy9_API, "mod_1c190dbfysy9._C_API", NULL);
