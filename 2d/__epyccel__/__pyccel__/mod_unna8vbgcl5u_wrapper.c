...
#define MOD_UNNA8VBGCL5U_WRAPPER

#include "mod_unna8vbgcl5u_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_unna8vbgcl5u_methods[] = {
    {
...
static struct PyModuleDef mod_unna8vbgcl5u_module = {
    ...
    0,
    mod_unna8vbgcl5u_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_unna8vbgcl5u(void)
{
    PyObject* mod;
    static void* Pymod_unna8vbgcl5u_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_unna8vbgcl5u_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_unna8vbgcl5u_API, "mod_unna8vbgcl5u._C_API", NULL);
