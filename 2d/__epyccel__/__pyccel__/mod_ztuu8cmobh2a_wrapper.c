...
#define MOD_ZTUU8CMOBH2A_WRAPPER

#include "mod_ztuu8cmobh2a_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_ztuu8cmobh2a_methods[] = {
    {
...
static struct PyModuleDef mod_ztuu8cmobh2a_module = {
    ...
    0,
    mod_ztuu8cmobh2a_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_ztuu8cmobh2a(void)
{
    PyObject* mod;
    static void* Pymod_ztuu8cmobh2a_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_ztuu8cmobh2a_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_ztuu8cmobh2a_API, "mod_ztuu8cmobh2a._C_API", NULL);
