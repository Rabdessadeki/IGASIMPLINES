...
#define MOD_PVRVDWLY0ZGB_WRAPPER

#include "mod_pvrvdwly0zgb_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_pvrvdwly0zgb_methods[] = {
    {
        "assemble_mass_1D",
...
static struct PyModuleDef mod_pvrvdwly0zgb_module = {
    ...
    0,
    mod_pvrvdwly0zgb_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_pvrvdwly0zgb(void)
{
    PyObject* mod;
    static void* Pymod_pvrvdwly0zgb_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_pvrvdwly0zgb_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_pvrvdwly0zgb_API, "mod_pvrvdwly0zgb._C_API", NULL);
