...
#define MOD_EAQJUZX3TK71_WRAPPER

#include "mod_eaqjuzx3tk71_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_eaqjuzx3tk71_methods[] = {
    {
...
static struct PyModuleDef mod_eaqjuzx3tk71_module = {
    ...
    0,
    mod_eaqjuzx3tk71_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_eaqjuzx3tk71(void)
{
    PyObject* mod;
    static void* Pymod_eaqjuzx3tk71_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_eaqjuzx3tk71_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_eaqjuzx3tk71_API, "mod_eaqjuzx3tk71._C_API", NULL);
