...
#define MOD_KPHBS1FCM1ZH_WRAPPER

#include "mod_kphbs1fcm1zh_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
/*........................................*/
static PyObject* bind_c_assemble_mass_1d_wrapper(PyObject* self, PyObject* args, PyObject* kwargs)
{
    PyObject* ne_obj;
    PyObject* degree_obj;
    PyObject* spans_obj;
...
static PyMethodDef mod_kphbs1fcm1zh_methods[] = {
    {
        "assemble_mass_1D",
        (PyCFunction)bind_c_assemble_mass_1d_wrapper,
...
static struct PyModuleDef mod_kphbs1fcm1zh_module = {
    ...
    0,
    mod_kphbs1fcm1zh_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_kphbs1fcm1zh(void)
{
    PyObject* mod;
    static void* Pymod_kphbs1fcm1zh_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_kphbs1fcm1zh_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_kphbs1fcm1zh_API, "mod_kphbs1fcm1zh._C_API", NULL);
