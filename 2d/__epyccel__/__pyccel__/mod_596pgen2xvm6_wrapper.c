...
#define MOD_596PGEN2XVM6_WRAPPER

#include "mod_596pgen2xvm6_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_596pgen2xvm6_methods[] = {
    {
        "assemble_mass_1D",
...
static struct PyModuleDef mod_596pgen2xvm6_module = {
    ...
    0,
    mod_596pgen2xvm6_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_596pgen2xvm6(void)
{
    PyObject* mod;
    static void* Pymod_596pgen2xvm6_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_596pgen2xvm6_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_596pgen2xvm6_API, "mod_596pgen2xvm6._C_API", NULL);
