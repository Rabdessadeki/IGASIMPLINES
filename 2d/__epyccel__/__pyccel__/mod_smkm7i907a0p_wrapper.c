...
#define MOD_SMKM7I907A0P_WRAPPER

#include "mod_smkm7i907a0p_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_smkm7i907a0p_methods[] = {
    {
...
static struct PyModuleDef mod_smkm7i907a0p_module = {
    ...
    0,
    mod_smkm7i907a0p_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_smkm7i907a0p(void)
{
    PyObject* mod;
    static void* Pymod_smkm7i907a0p_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_smkm7i907a0p_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_smkm7i907a0p_API, "mod_smkm7i907a0p._C_API", NULL);
