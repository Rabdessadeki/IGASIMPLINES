...
#define MOD_D850LYE980E4_WRAPPER

#include "mod_d850lye980e4_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_d850lye980e4_methods[] = {
    {
...
static struct PyModuleDef mod_d850lye980e4_module = {
    ...
    0,
    mod_d850lye980e4_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_d850lye980e4(void)
{
    PyObject* mod;
    static void* Pymod_d850lye980e4_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_d850lye980e4_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_d850lye980e4_API, "mod_d850lye980e4._C_API", NULL);
