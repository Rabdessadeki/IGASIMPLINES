...
#define MOD_0W6EEBIQAW7X_WRAPPER

#include "mod_0w6eebiqaw7x_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_0w6eebiqaw7x_methods[] = {
    {
        "assemble_mass_1D",
...
static struct PyModuleDef mod_0w6eebiqaw7x_module = {
    ...
    0,
    mod_0w6eebiqaw7x_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_0w6eebiqaw7x(void)
{
    PyObject* mod;
    static void* Pymod_0w6eebiqaw7x_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_0w6eebiqaw7x_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_0w6eebiqaw7x_API, "mod_0w6eebiqaw7x._C_API", NULL);
