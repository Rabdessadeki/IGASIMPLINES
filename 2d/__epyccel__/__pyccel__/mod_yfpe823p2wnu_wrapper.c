...
#define MOD_YFPE823P2WNU_WRAPPER

#include "mod_yfpe823p2wnu_wrapper.h"
#include <stdlib.h>
#include <stdint.h>
#include "ndarrays.h"
...
static PyMethodDef mod_yfpe823p2wnu_methods[] = {
    {
        "assemble_norm_ex01",
...
static struct PyModuleDef mod_yfpe823p2wnu_module = {
    ...
    0,
    mod_yfpe823p2wnu_methods,
};

/*........................................*/

PyMODINIT_FUNC PyInit_mod_yfpe823p2wnu(void)
{
    PyObject* mod;
    static void* Pymod_yfpe823p2wnu_API[0];
    PyObject* c_api_object_0001;
    mod = PyModule_Create(&mod_yfpe823p2wnu_module);
    if (mod == NULL)
    {
        return NULL;
    }
    c_api_object_0001 = PyCapsule_New((void *)Pymod_yfpe823p2wnu_API, "mod_yfpe823p2wnu._C_API", NULL);
